========================================================================
    APLICACIÓN DE CONSOLA: AlgoritmoGenericoMochila Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación AlgoritmoGenericoMochila.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación AlgoritmoGenericoMochila.


AlgoritmoGenericoMochila.vcxproj
...
AlgoritmoGenericoMochila.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado AlgoritmoGenericoMochila.pch y un archivo de tipos precompilados llamado StdAfx.obj.
